...
- **Blockchain & Web3**: Simple applications for different systems usage (eg: log auditing)
- **Other**: Other learning repos, proof-of-concepts, MVP projects, with different technologies
